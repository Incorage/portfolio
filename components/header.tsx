...
export function Header() {
  ...
  return (
    <>
      ...
      <div
        aria-live="polite"
        className={`fixed right-6 top-24 z-[60] rounded-full border border-black/10 bg-white px-5 py-3 text-sm font-medium leading-5 text-ink shadow-lg transition-[opacity,transform] duration-500 ease-[cubic-bezier(0.22,1,0.36,1)] ${
