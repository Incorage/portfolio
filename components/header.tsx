...
export function Header() {
  ...
  return (
    <>
      ...
      <div
        aria-live="polite"
        className={`fixed right-6 top-24 z-[60] rounded-full bg-primary px-5 py-3 text-sm font-semibold leading-5 text-invert shadow-button transition-[opacity,transform] duration-500 ease-[cubic-bezier(0.22,1,0.36,1)] ${
