...
export const assets = {
  ...
  dragIcon: publicAsset("/drag-icon.svg"),
  ...
  project1Previews: [
    publicAsset("/cases/previews/Case_1/1.webp"),
    publicAsset("/cases/previews/Case_1/2.webp"),
    publicAsset("/cases/previews/Case_1/3.webp"),
    publicAsset("/cases/previews/Case_1/4.webp")
  ],
  project2: [
  ...
  project2Previews: [
    publicAsset("/cases/previews/Case_2/1.webp"),
    publicAsset("/cases/previews/Case_2/2.webp"),
    publicAsset("/cases/previews/Case_2/3.webp"),
    publicAsset("/cases/previews/Case_2/4.webp")
  ],
  project3: [
  ...
  project3Previews: [
    publicAsset("/cases/previews/Case_3/1.webp"),
    publicAsset("/cases/previews/Case_3/2.webp"),
    publicAsset("/cases/previews/Case_3/3.webp")
  ]
} as const;
